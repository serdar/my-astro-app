...
import worker from "/home/serdar/dev/my-astro-app/.wrangler/tmp/bundle-PQIeWw/middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "/home/serdar/dev/my-astro-app/node_modules/.pnpm/wrangler@3.28.2_@cloudflare+workers-types@4.20240208.0/node_modules/wrangler/templates/middleware/common.ts";

// We need to preserve all of the exports from the worker
export * from "/home/serdar/dev/my-astro-app/.wrangler/tmp/bundle-PQIeWw/middleware-insertion-facade.js";
